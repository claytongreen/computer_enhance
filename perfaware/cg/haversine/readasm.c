...
extern void read_x1(uint64_t count, uint64_t *data);
extern void read_x2(uint64_t count, uint64_t *data);
extern void read_x3(uint64_t count, uint64_t *data);
extern void read_x4(uint64_t count, uint64_t *data);
extern void read_x5(uint64_t count, uint64_t *data);
extern void read_x8(uint64_t count, uint64_t *data);
